...
exports.REUSE_CACHE_CONSTRAINT = new core_1.InjectionToken("Router reuse cache constraint");
var RouteReuseCache = (function () {
    function RouteReuseCache(router, constraint, location, scrollWrapper) {
        ...
        if (location.getCurrentPageId) {
            router.events.subscribe(function (e) {
                if (e instanceof RouteEvents_1.NavigationEnd) {
                ...
                else if (e instanceof RouteEvents_1.NavigationStart) {
    ...
    RouteReuseCache.prototype.ensureCache = function (component, routeCtx) {
        ...
        var cacheBack = component.instance.reuseRouteStrategy === Config_1.ReuseRouteStrategy.CACHEBACK;
        var pageId = this.getCurrentPageId();
        if (!pageId) {
    ...
    RouteReuseCache.prototype.newRouteNavigation = function () {
        ...
        var _loop_1 = function (cacheItem) {
            if (cacheItem.reuseStrategy === Config_1.ReuseRouteStrategy.CACHEBACK) {
...
RouteReuseCache.ctorParameters = function () { return [
    ...
    { type: undefined, decorators: [{ type: core_1.Inject, args: [exports.REUSE_CACHE_CONSTRAINT,] },] },
    { type: undefined, decorators: [{ type: core_1.Inject, args: [common_1.LocationStrategy,] },] },
    { type: RouterScrollWrapper_1.RouterScrollWrapper, },
]; };
exports.RouteReuseCache = RouteReuseCache;
...
exports.ReuseCacheItem = ReuseCacheItem;
