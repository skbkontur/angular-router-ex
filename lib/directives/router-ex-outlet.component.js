import { Attribute, Component, EventEmitter, Injector, Input, Output, ViewChild, ViewContainerRef } from "@angular/core";
...
var RouterExOutletComponent = /** @class */ (function () {
    ...
    RouterExOutletComponent.prototype.activate = function (route, url, componentType, resolver, injector, force) {
        var _this = this;
        ...
        var noPrerender = function () {
            ...
            _this.activateComponent(componentToActivate, routeContext);
            onDone();
            return Promise.resolve({
        ...
        var prerenderComponent = componentToActivate.instance;
        if (prerenderComponent.routePrerender) {
            ...
            if (this.activatedComponent) {
                return new Promise(function (resolve) {
                    var delay$ = delay.call(of(true), prerenderComponent.fallbackTimeout || _this.prerenderFallback);
    ...
    /**
         * Replace current activated component with specified one
         */
    RouterExOutletComponent.prototype.activateComponent = /**
         * Replace current activated component with specified one
         */
    function (ref, routeCtx) {
...
function routeEquals(route, route2) {
