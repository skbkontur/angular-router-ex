...
describe("Router", () => {
    ...
    describe("multiple outlets", () => {
        beforeEach(() => {
            browser.get("/multiple-outlets");
            click("multiple-outlets-another-outlet-link");
        });

        it("should not detach component from default outlet, while navigating over other outlet routes", () => {
            expectDisplayed("multiple-outlets-default-outlet-content");
            expectDisplayed("multiple-outlets-another-outlet-content");
            click("multiple-outlets-another-outlet-next-link");
            expectDisplayed("multiple-outlets-default-outlet-content");
            expectDisplayed("multiple-outlets-another-outlet-content");
        });
